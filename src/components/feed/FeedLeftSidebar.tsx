            ...
            [
              {
                ...
                role: "CEO of Apple",
                img: `${IMG}/people1.png`,
                imgClass: "_info_img" as const,
              },
              {
                name: "Ryan Roslansky",
                role: "CEO of Linkedin",
                img: `${IMG}/people2.png`,
                imgClass: "_info_img1" as const,
              },
              {
                name: "Dylan Field",
                role: "CEO of Figma",
            ...
            <div key={p.name} className="_left_inner_area_suggest_info">
              <div className="_left_inner_area_suggest_info_box">
                <div className="_left_inner_area_suggest_info_image">
                  <Link href="/feed">
                    <img src={p.img} alt="" className={p.imgClass} />
                  </Link>
                </div>
              ...
              <div className="_left_inner_area_suggest_info_link">
                <Link href="/feed" className="_info_link">
                  Connect
                </Link>
              </div>
            </div>
      ...
      <div className="_layout_left_sidebar_inner">
        <div className="_left_inner_area_event _padd_t24 _padd_b6 _padd_r24 _padd_l24 _b_radious6 _feed_inner_area">
          <div className="_left_inner_event_content">
            ...
            <Link href="/feed" className="_left_inner_event_link">
              See all
            </Link>
          </div>
          {[1, 2].map((i) => (
            <Link key={i} className="_left_inner_event_card_link" href="/feed">
              <div className="_left_inner_event_card">
                <div className="_left_inner_event_card_iamge">
                  <img
                    src={`${IMG}/feed_event1.png`}
                    alt=""
                    className="_card_img"
                  />
                </div>
