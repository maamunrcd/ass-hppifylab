...
import { displayName, type CurrentUserProfile } from "@/types/user";
...
function NotificationBody({ jobs }: { jobs: boolean }): ReactNode {
  if (jobs) {
    return (
      <>
        <span className="_notify_txt_link">Steve Jobs</span> posted a link in
        your timeline.
      </>
    );
  }
  return (
    <>
      ...
      <span className="_notify_txt_link">Freelacer usa</span> to{" "}
...
export default function FeedHeader({
  ...
  const profileName = currentUser ? displayName(currentUser) : "Guest";
  ...
  useEffect(() => {
    ...
    const close = (e: MouseEvent) => {
      ...
      if (notifyOpen && notifyRef.current && !notifyRef.current.contains(t)) {
        setNotifyOpen(false);
        ...
        <div className="container _custom_container">
          <div className="_logo_wrap">
            <Link className="navbar-brand" href="/feed">
              <img src={`${IMG}/logo.svg`} alt="Image" className="_nav_logo" />
            </Link>
          </div>
          <button
          ...
          <div className="navbar-collapse" id="navbarSupportedContent">
            <div className="_header_form ms-auto">
              <form className="_header_form_grp" action="#" role="search">
                <svg
                    ...
                    <div className="_notifications_content">
                      ...
                      <div className="_notification_box_right">
                        ...
                        <div
                          ...
                          style={{
                            display: notifyGearOpen ? "block" : undefined,
                          }}
                        >
            ...
            >
              <UserAvatar
                ...
                imgClassName="_nav_profile_img user-avatar-img"
                src={currentUser?.avatarUrl}
                name={profileName}
              />
              <div className="_header_nav_dropdown">
                <p className="_header_nav_para">{profileName}</p>
                <button
              ...
              >
                <div className="_nav_profile_dropdown_info">
                  <UserAvatar
                    className="_nav_profile_dropdown_image"
                    imgClassName="_nav_drop_img user-avatar-img"
                    src={currentUser?.avatarUrl}
                    name={profileName}
                  />
                  <div className="_nav_profile_dropdown_info_txt">
                    <h4 className="_nav_dropdown_title">{profileName}</h4>
                    ...
                    <Link href="/feed" className="_nav_drop_profile">
                      View Profile
                    </Link>
                  </div>
                </div>
                ...
                <ul className="_nav_dropdown_list">
                  <li className="_nav_dropdown_list_item">
                    <Link href="/feed" className="_nav_dropdown_link">
                      <div className="_nav_drop_info">
                        <span>
                          <svg
                            ...
                            aria-hidden
                          >
                            <path fill="#377DFF" d={SETTINGS_GEAR_PATH} />
                          </svg>
                        </span>
                        Settings
                      </div>
                  ...
                  <li className="_nav_dropdown_list_item">
                    <button
                      type="button"
                      className="_nav_dropdown_link w-100 text-start border-0 bg-transparent p-0"
                      onClick={() => logout()}
                ...
                <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                  <div className="_header_mobile_menu_top_inner">
                    ...
                    <div className="_header_mobile_menu_right">
                      <form className="_header_form_grp" action="#">
